...
de sentinela, ela sera usada como ponto de parada nas funcoes de busca
...
/*
aponta-se o novo item para a sentinela (cabeca), faz-se o ultimo elemento apontar para o novo, o novo elemento ser o ultimo da lista e
...
no valido, o auxiliar (um no anterior) apontara para o proximo do no a
ser removido e o tamanho da lista e decrementado
*/
